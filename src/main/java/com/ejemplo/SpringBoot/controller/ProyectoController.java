...
public class ProyectoController {
    ...
    public ResponseEntity<Proyecto> modificarProyecto(@PathVariable Long id, @RequestBody Proyecto proyectoBody) {
        Proyecto proyecto = proyectoService.buscarProyecto(id);
        if (proyecto != null) {
            if (proyectoBody.getTitulo() != null)
                proyecto.setTitulo(proyectoBody.getTitulo());
            if (proyectoBody.getDescripcion() != null)
                proyecto.setDescripcion(proyectoBody.getDescripcion());
            if (proyectoBody.getFechaRealizacion() != null)
                proyecto.setFechaRealizacion(proyectoBody.getFechaRealizacion());
            if (proyectoBody.getProyectoUrl() != null)
                proyecto.setProyectoUrl(proyectoBody.getProyectoUrl());
            proyectoService.crearProyecto(proyecto);
